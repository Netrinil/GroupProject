...
-- --------------------------------------
-- Main links/pages
INSERT INTO pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (1, 'Nom Noms', 'Home', 'Welcome to our website. Grab a bite and enjoy.', 0, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Nom Noms', Header1 = 'Home', Text1 = 'Welcome to our website. Grab a bite and enjoy.', ParentPage = 0, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (2, 'About', 'About Us', 'Zero score and 1 month ago, we were set upon by the reality of PHP. Now, our foe lies beneath us, broken and beaten, and lo, here we stand today to say “Let’s get this bread.”', 0, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'About', Header1 = 'About Us', Text1 = 'Zero score and 1 month ago, we were set upon by the reality of PHP. Now, our foe lies beneath us, broken and beaten, and lo, here we stand today to say “Let’s get this bread.”', ParentPage = 0, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (3, 'Recipe Category', 'Recipe links list', 'Recipe', 0, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Recipe Category', Header1 = 'Recipe links list', Text1 = 'Recipe', ParentPage = 0, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (4, 'Contact Us', 'Contact Info', 'support@nom.nom 800-366-4484 178 S Rio Grande St, Salt Lake City, UT 84101', 0, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Contact Us', Header1 = 'Contact Info', Text1 = 'support@nom.nom 800-366-4484 178 S Rio Grande St, Salt Lake City, UT 84101', ParentPage = 0, isActive = 1, Creator = 1, RequireApproval = 0;

-- --------------------------------------
-- Category Pages
INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (5, 'Breakfast', 'Breakfast', 'My breakfast text. My breakfast text. My breakfast text. ', 3, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Breakfast', Header1 = 'Breakfast', Text1 = 'My breakfast text. My breakfast text. My breakfast text. ', ParentPage = 3, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (6, 'Lunch', 'Lunch', 'My lunch text. My lunch text. My lunch text. ', 3, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Lunch', Header1 = 'Lunch', Text1 = 'My lunch text. My lunch text. My lunch text. ', ParentPage = 3, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (7, 'Dinner', 'Dinner', 'My dinner text. My dinner text. My dinner text. ', 3, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Dinner', Header1 = 'Dinner', Text1 = 'My dinner text. My dinner text. My dinner text. ', ParentPage = 3, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (8, 'Snacks', 'Snacks', 'My snack text. My snack text. My snack text. ', 3, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Snacks', Header1 = 'Snacks', Text1 = 'My snack text. My snack text. My snack text. ', ParentPage = 3, isActive = 1, Creator = 1, RequireApproval = 0;
...
ParentPage = 5,  isActive = 1, Creator = 1, RequireApproval = 0;
...
VALUES    (10, 'Spam Musubi Onigiri', 'Lunch', 'Ingredients: 1 cup Cooked Rice, 1.5tbsp Furikake, half sheet of nori or seaweed, half can of spam, 1/4 tbsp of canola oil. Instruction: 1. Mix the furikake with the sushi rice and set aside. 2. Put the small cookie cutter through your Spam to get a cylinder. Cut the cylinder into 6 disks. You can use the rectangular leftover pieces to make the traditional Spam musubi. The bits and pieces can be used for what ever your heart desires.
 3. Over medium heat, add the Canola oil and sear both side to get a crunch (2-3 minutes on each side). 4. In the bigger cookie cutter, fill the bottom 1/3 with rice. Place spam on top and fill with rice (make sure to press down tight on the sides).
  5. Wrap the nori around the rice and you are done.', 6, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Spam Musubi Onigiri', Header1 = 'Lunch', Text1 = 'Ingredients: 1 cup Cooked Rice, 1.5tbsp Furikake, half sheet of nori or seaweed, half can of spam, 1/4 tbsp of canola oil, Instruction: 1. Mix the furikake with the sushi rice and set aside. 2. Put the small cookie cutter through your Spam to get a cylinder. Cut the cylinder into 6 disks. You can use the rectangular leftover pieces to make the traditional Spam musubi. The bits and pieces can be used for what ever your heart desires.
 3. Over medium heat, add the Canola oil and sear both side to get a crunch (2-3 minutes on each side). 4. In the bigger cookie cutter, fill the bottom 1/3 with rice. Place spam on top and fill with rice (make sure to press down tight on the sides).
  5. Wrap the nori around the rice and you are done', ParentPage = 6, isActive = 1, Creator = 1, RequireApproval = 0;
...
, ParentPage = 7, isActive = 1, Creator = 1, RequireApproval = 0;
...
INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (13, 'Waffles', 'Breakfast', 'Leggo my Eggo.', 5, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Waffles', Header1 = 'Breakfast', Text1 = 'Leggo my Eggo.', ParentPage = 5, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (14, 'Chicken & Waffles', 'Lunch', 'Best of both', 6, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Chicken & Waffles', Header1 = 'Lunch', Text1 = 'Best of both', ParentPage = 6, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (15, 'Chicken', 'Dinner', "It's a bird", 7, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Chicken', Header1 = 'Dinner', Text1 = "It's a bird", ParentPage = 7, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (16, 'Waffles & Chicken', 'Snacks', 'Both the best', 8, 1, 1, 0)
ON DUPLICATE KEY UPDATE
Title = 'Waffles & Chicken', Header1 = 'Snacks', Text1 = 'Both the best', ParentPage = 8, isActive = 1, Creator = 1, RequireApproval = 0;

INSERT INTO Pages ( id, Title, Header1, Text1, ParentPage, isActive, Creator, RequireApproval)
VALUES    (17, 'Approval Waffles', 'Snacks', 'Both the best', 8, 1, 2, 1)
ON DUPLICATE KEY UPDATE
Title = 'Approval Waffles', Header1 = 'Snacks', Text1 = 'Both the best', ParentPage = 8, isActive = 1, Creator = 2, RequireApproval = 1;